            ...
            <div className="col-lg-6 about-content m-b30">
                    ...
                    <Tab.Container defaultActiveKey={'Mission'}>
                        ...
                        <Tab.Content className="tab-content m-sm-b30 m-b40 p-r30" id="myTabContent">
                            ...
                            <Tab.Pane eventKey={'Vision'}>
                                <div className="content">
                                    <p>
                                        To be the leading gym that transforms lives, fostering a culture of health, wellness, and lifelong fitness for people of all ages and abilities.
                                    </p>
                                </div>
                            </Tab.Pane>
                        </Tab.Content>
                ...
                <div className="contact-us">
                    ...
                    <div className="content">
                        ...
                        <h4 className="number">12345 67890</h4>
                    </div>
                </div>
            </div>
